#+TITLE: Anki-Editor
#+SUBTITLE: Emacs minor mode for making Anki cards with Org
#+DESCRIPTION: Emacs minor mode for making Anki cards with Org
#+AUTHOR: Lamprinos Chatziioannou
#+DATE: <2025-12-06 Sat>

* Disclaimer
NOTICE! This fork has been significantly modified compared to the origin.
Do not use till this note has been removed.

The original ~anki-editor~ package was developed by [[https://github.com/louietan][Lei Tan (@louietan)]]. Feel free
to support them for making this open-source in the first place. In their own
words:
#+begin_quote
  Donation is not required, but if you like my work and want to show
  your appreciation you can donate via [[https://paypal.me/louietanlei][PayPal]], every cent is
  appreciated, thanks for your support :)
#+end_quote

* Installation
A sample installation, for anyone using ~straight~ and ~use-package~:

#+begin_src elisp
(use-package anki-editor
  :straight (anki-editor :type git :host github :repo "chaziiola/anki-editor")
  :after org
  :general
  (lc/leader-keys
    "a"  '(:ignore t :which-key "anki")
    "ap" '(anki-editor-push-notes :which-key "push-notes")
    )
  :init
  (setq anki-editor-create-decks t ;; Allow anki-editor to create a new deck if it doesn't exist
	anki-editor-org-tags-as-anki-tags t)
  :custom
  (anki-editor-ox-latex-environment-wrapper 'anki-editor-wrap-latex-mathjax)
  (anki-editor-latex-delimiter-map anki-editor-latex-delimiter-map-mathjax)
  )
#+end_src

** Requirements
- [[https://github.com/FooSoft/anki-connect#installation][anki-connect]], an Anki add-on required by this package to interact with Anki.
- curl
